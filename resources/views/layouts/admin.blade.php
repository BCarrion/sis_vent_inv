    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-mini"><b>SVI</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Sistema VentInv</b></span>
        </a>
      ...
      <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2015-2020 Berna Carrion</a>.</strong> All rights reserved.
      </footer>
