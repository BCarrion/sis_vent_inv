...
@section ('contenido')
  <div class="row">
    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
      <h3>Listado de ventas {{$fecha_reporte}}| <a href="{{URL::action('VentasDiaController@reporteDia', ['download'=>'pdf'])}}"><button class="btn btn-success" type="button" name="button">Descargar</button></a></h3>
    </div>
  </div>
  <div class="row">
